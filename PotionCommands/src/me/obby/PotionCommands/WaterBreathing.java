...
public class WaterBreathing implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		if (label.equalsIgnoreCase("waterBreathing") || label.equalsIgnoreCase("wb")) {
	...
	public void potion(Player player) {
		String potionName = "waterBreathing";
		String potionNameChat = "Water Breathing";
		...
		player.addPotionEffect(new PotionEffect(PotionEffectType.WATER_BREATHING, duration, power));
