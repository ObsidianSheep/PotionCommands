...
public class Haste implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		if (label.equalsIgnoreCase("haste")) {
	...
	public void potion(Player player) {
		String potionName = "haste";
		String potionNameChat = "Haste";
		...
		player.addPotionEffect(new PotionEffect(PotionEffectType.FAST_DIGGING, duration, power));
